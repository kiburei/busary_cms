...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { address: @parent.address, id_number: @parent.id_number, name: @parent.name, phone: @parent.phone } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { address: @parent.address, id_number: @parent.id_number, name: @parent.name, phone: @parent.phone } }
